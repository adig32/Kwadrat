...
public class ReplyMessageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        message_to.setText(intent.getStringExtra("user_to_login"));
        about_flat.setText(intent.getStringExtra("flat_id"));

        btn_send.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                sendMessage(about_flat.getText().toString(), intent.getStringExtra("user_from_email"), message_to.getText().toString(), message.getText().toString());
            }
        });
    }
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_OWNER_LOGIN,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(ReplyMessageActivity.this, "Error " +e.toString(), Toast.LENGTH_SHORT).show();
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(ReplyMessageActivity.this, "Error " +error.toString(), Toast.LENGTH_SHORT).show();
                    }
                })
        {
            @Override
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (success.equals("1")) {
                                ...
                                Toast.makeText(ReplyMessageActivity.this, "Wiadomość wysłana pomyślnie!", Toast.LENGTH_SHORT).show();
