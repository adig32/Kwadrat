...
public class MyOfferDetailsActivity extends AppCompatActivity {
    ...
    private String URL_DELETE_OFFER = "http://192.168.8.100/kwadrat/deleteoffer.php";
    private String URL_DEACTIVATE_OFFER = "http://192.168.8.100/kwadrat/deactivateoffer.php";
    private String URL_ACTIVATE_OFFER = "http://192.168.8.100/kwadrat/activateoffer.php";
    private String URL_OWNER_EMAIL = "http://192.168.8.100/kwadrat/owneremail.php";
    private String URL_VISIBILITY = "http://192.168.8.100/kwadrat/visibility.php";
    private Button btn_delete, btn_deactivate, btn_rent;
    String email, visibility;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_deactivate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(visibility.equals("1")) deactivateOffer(mId);
                if(visibility.equals("0")) activateOffer(mId);
            }
        });
        ...
        btn_rent.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MyOfferDetailsActivity.this, RentFlatActivity.class);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_GET_DATA,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(MyOfferDetailsActivity.this, "Error " +e.toString(), Toast.LENGTH_SHORT).show();
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(MyOfferDetailsActivity.this, "Error " +error.toString(), Toast.LENGTH_SHORT).show();
                    }
                })
        {
            @Override
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            EquipmentAdapter adapter = new EquipmentAdapter(MyOfferDetailsActivity.this, flatEquipmentList);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            EquipmentAdapter adapter = new EquipmentAdapter(MyOfferDetailsActivity.this, kitchenEquipmentList);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            EquipmentAdapter adapter = new EquipmentAdapter(MyOfferDetailsActivity.this, bathroomEquipmentList);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            EquipmentAdapter adapter = new EquipmentAdapter(MyOfferDetailsActivity.this, mediaList);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            PhotoAdapter adapter = new PhotoAdapter(MyOfferDetailsActivity.this, photoList);
    ...
    private void deleteOffer(String id){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_DELETE_OFFER,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        try{
                            ...
                            if (success.equals("1")) {
                                Toast.makeText(MyOfferDetailsActivity.this, "Ogłoszenie usunięte pomyślnie!", Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(MyOfferDetailsActivity.this, HomeActivity.class);
                            ...
                            e.printStackTrace();
                            Toast.makeText(MyOfferDetailsActivity.this, "Błąd aktualizacji! " + e.toString(), Toast.LENGTH_SHORT).show();
                        }
                    }
                },
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(MyOfferDetailsActivity.this, "Błąd aktualizacji! " + error.toString(), Toast.LENGTH_SHORT).show();
                    }
                })
    ...
    private void deactivateOffer(String id){
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try{
                            ...
                            if (success.equals("1")) {
                                Toast.makeText(MyOfferDetailsActivity.this, "Ogłoszonie deaktywowane pomyślnie!", Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(MyOfferDetailsActivity.this, HomeActivity.class);
    ...
    private void activateOffer(String id){

        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_ACTIVATE_OFFER,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        try{
                            ...
                            if (success.equals("1")) {
                                Toast.makeText(MyOfferDetailsActivity.this, "Ogłoszonie aktywowane pomyślnie!", Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(MyOfferDetailsActivity.this, HomeActivity.class);
    ...
    private void getOwnerMail(String flat_id) {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_OWNER_EMAIL,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        try {
    ...
    private void getVisibility(String flat_id) {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_VISIBILITY,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        try {
                            ...
                            if (success.equals("1")) {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    if(object.getString("visibility").equals("1")) btn_deactivate.setText("Deaktywuj");
                                    if(object.getString("visibility").equals("0")) btn_deactivate.setText("Aktywuj");
                                }
                            }
