...
public class OfferModel {
    ...
    public OfferModel(String id, String street, String city_name, String district_name, String rent, String flat_area, String login, String thumbnail, String logged_user_email) {
        this.id = id;
        this.street = street;
