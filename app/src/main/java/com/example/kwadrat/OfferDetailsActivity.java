...
public class OfferDetailsActivity extends AppCompatActivity {
    ...
    private String URL_GET_NOTE = "http://192.168.8.100/kwadrat/getnote.php";

    private String URL_ADD_TO_FAVOURITES = "http://192.168.8.100/kwadrat/addtofavourites.php";

    private Button btn_add_to_favourites, btn_send_message;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_send_message.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(OfferDetailsActivity.this, SendMessageActivity.class);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_GET_DATA,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(OfferDetailsActivity.this, "Error " +e.toString(), Toast.LENGTH_SHORT).show();
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(OfferDetailsActivity.this, "Error " +error.toString(), Toast.LENGTH_SHORT).show();
                    }
                })
        {
            @Override
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            EquipmentAdapter adapter = new EquipmentAdapter(OfferDetailsActivity.this, flatEquipmentList);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            EquipmentAdapter adapter = new EquipmentAdapter(OfferDetailsActivity.this, kitchenEquipmentList);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            EquipmentAdapter adapter = new EquipmentAdapter(OfferDetailsActivity.this, bathroomEquipmentList);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            EquipmentAdapter adapter = new EquipmentAdapter(OfferDetailsActivity.this, mediaList);
    ...
    private void addToFavourites(String id, String email){

        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_ADD_TO_FAVOURITES,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        try{
                            ...
                            if (success.equals("1")) {
                                Toast.makeText(OfferDetailsActivity.this, "Zaobserwowano pomyślnie!", Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(OfferDetailsActivity.this, FavouritesActivity.class);
                            ...
                            e.printStackTrace();
                            Toast.makeText(OfferDetailsActivity.this, "Błąd obserwowania! " + e.toString(), Toast.LENGTH_SHORT).show();
                        }
                    }
                },
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(OfferDetailsActivity.this, "Błąd obserwowania! " + error.toString(), Toast.LENGTH_SHORT).show();
                    }
                })
    ...
    private void getNote(String id) {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_GET_NOTE,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        try {
                            ...
                            if (success.equals("1")) {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    if(object.getString("note").equals("null")) note.setText("brak ocen");
                                    else note.setText("średnia ocena: " + object.getString("note"));
                                }
                            }
